...
- **Logic**:
    - Accept a `filename` query parameter (e.g., `ensemble_forecast.png`).
...
- **Changes**:
    ...
    - **Visualizations**: Display `ensemble_forecast.png` and `forecast_comparison.png` using the new image API.
